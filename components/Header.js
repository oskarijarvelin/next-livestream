...
export default function Header() {
    return (
        <Flex bg="bg" color="body" borderBottom={{base: "0px solid #DEDEDE", lg: "1px solid #DEDEDE"}} alignItems="center" justifyContent={{base: "flex-start", md: "space-between"}} grow={{base: 0, md: 1}} wrap="wrap">
